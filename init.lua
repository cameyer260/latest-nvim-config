...
do
  ...
  -- [[ Colorscheme ]]
  -- The colorscheme (Kanagawa) is installed and loaded in
  -- `lua/custom/plugins/colorscheme.lua`, which runs at the end of this file.
  -- (Kickstart ships tokyonight here by default; we replaced it.)
  -- If you want to see what colorschemes are installed, use `:Telescope colorscheme`.
...
do
  ...
  local servers = {
    ...
    eslint = {}, -- linting for JS/TS (uses your project's eslint config)
    html = {}, -- HTML
    cssls = {}, -- CSS / SCSS / Less
    emmet_language_server = {}, -- Emmet expansion in HTML/JSX/TSX
    tailwindcss = {}, -- Tailwind class completion (only attaches in Tailwind projects)
  ...
  vim.list_extend(ensure_installed, {
    -- Extra tools (formatters) that aren't LSP servers but we want installed
    'prettierd', -- formats JS/TS/JSX/TSX/JSON/CSS/HTML/YAML/Markdown
  })
...
do
  ...
  require('conform').setup {
    ...
    -- External formatters per filetype. `<leader>f` runs these; LSP is the fallback.
    formatters_by_ft = {
      lua = { 'stylua' },
      python = { 'ruff_format' },
      rust = { 'rustfmt' },
